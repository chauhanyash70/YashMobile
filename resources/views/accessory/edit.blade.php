                        ...
                        <div class="card-body py-4">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <x-intl-tel-input name="supplier_mobile_number" id="supplier_mobile_number" value="{{ old('supplier_mobile_number', $supplier->phone ?? '') }}" class="@error('supplier_mobile_number') is-invalid @enderror" required />
