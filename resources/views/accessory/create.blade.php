...
@section('header_title', $header_title ?? 'Add Accessory')
@section('tagline', $tagline ?? 'Register a new accessory in the inventory.')
                ...
                <form action="{{ route('accessories.store') }}" method="POST" id="accessoryCreateForm">
                    ...
                    <div class="card mb-3">
                        <div class="card-header d-flex justify-content-between align-items-center py-3">
                            <h5 class="mb-0 fw-bold">
                                <i class="iconoir-headset me-2 text-primary"></i> Add New Accessory
                            </h5>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control fw-bold @error('hsn') is-invalid @enderror"
                                        id="hsn" name="hsn" value="{{ old('hsn') }}" placeholder="e.g. ACC-001"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('color') is-invalid @enderror"
                                        id="color" name="color" value="{{ old('color') }}" placeholder="e.g. Black">
                                    @error('color')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group has-validation">
                                        ...
                                        <input type="number" step="0.01"
                                            ...
                                            value="{{ old('purchase_price', '0.00') }}" placeholder="0.00" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group has-validation">
                                        ...
                                        <input type="number" step="0.01"
                                            ...
                                            name="sale_price" value="{{ old('sale_price', '0.00') }}" placeholder="0.00"
                                            required>
                                        @error('sale_price')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                    ...
                    <div class="d-flex justify-content-end gap-2 mb-4">
                        ...
                        <button type="submit" class="btn btn-primary px-5">
                            <i class="iconoir-floppy-disk me-1"></i> Save Accessory
                        </button>
                    </div>
